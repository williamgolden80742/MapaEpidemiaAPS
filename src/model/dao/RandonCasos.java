   ...
   public void create() {
        ...
        try {
            ...
            for (int i = 0; i < 10000; i++) {
                stmt = con.prepareStatement("INSERT INTO Pacientes (Idpaciente,nomecompleto,idCidade)VALUES("+(i+23952)+",'"+nomes[gerador.nextInt(100)]+"',"+cidade[gerador.nextInt(5)]+");");  
                stmt.executeUpdate();
                stmt = con.prepareStatement("INSERT INTO Exames (IdExame,Idpaciente)VALUES("+(i+23952)+","+(i+23952)+");"); 
                stmt.executeUpdate();
                stmt = con.prepareStatement("INSERT INTO Positivos (IdExame,IdDoenca,resultado)VALUES("+(i+23877)+","+(2+gerador.nextInt(4))+",1);");           
                stmt.executeUpdate();
            }   
